...
bool SceneLevel1::proximitycheck(float smallx, float largex, float smallz, float largez)
{
...
void SceneLevel1::RenderModelOnScreen(Mesh* mesh, float size, float Rotate, int rX, int rY, int rZ, float x, float y, float z, bool LightYN)
{
    Mtx44 ortho;
